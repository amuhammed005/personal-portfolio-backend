      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <p className="text-muted-foreground text-sm">{formatDate(project.date)}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="prose prose-invert max-w-none">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-foreground mb-4 mt-12">Technologies Used</h3>
          ...
          >
            <div className="bg-card border border-border rounded-lg p-6 sticky top-24">
              <h3 className="font-bold text-foreground mb-6">Project Details</h3>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-foreground font-medium">{formatDate(project.date)}</p>
                </div>
